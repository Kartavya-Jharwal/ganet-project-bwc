...
This document captures the key architectural and design decisions made for **Ganet** (Adaptive Efficiency / Team BWC engineering archive), along with the rationale behind each choice.

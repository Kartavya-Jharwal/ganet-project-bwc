...
from quant_monitor.backtest.stress import define_stress_scenarios, historical_scenario_replay
...
def test_historical_scenario_replay():
    ...
    returns = pd.DataFrame(
        {"AAPL": [-0.05, -0.02, -0.10, 0.01, -0.05], "TLT": [0.01, 0.02, 0.03, -0.01, 0.02]},
        index=dates,
    )
